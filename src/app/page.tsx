                    ...
                    <div className="min-h-[50vh] flex flex-col items-center justify-center bg-secondary bg-[url(/images/home/clouds.svg)] bg-no-repeat bg-top w-full overflow-x-hidden relative lg:bg-[url(/images/home/university_desktop.svg)] lg:h-full lg:bg-transparent lg:bg-contain lg:bg-[center_right] lg:items-start lg:max-w-6xl">
                        ...
                        <div className="flex-col items-start justify-center hidden w-[40vw] lg:flex lg:gap-8">
                            ...
                            <p className="font-medium text-left text-accent text-md lg:w-80">
                                Prepare-se para o sucesso global. No
                                Instituto Van Veen, você encontra todo
                                apoio necessário para entrar nas
                ...
                <section className="justify-start section h-fit gap-6">
                    <Container className="flex flex-col justify-center items-start gap-4">
                        ...
                        <p className="section-subtitle indent-6">
                            Nossos resultados falam por si. Com um
                            impressionante recorde de aprovações
                            internacionais, temos orgulho em ajudar
                            estudantes a conquistarem vagas nas
                            melhores universidades ao redor do mundo.
                        </p>
                    </Container>
                            ...
                            <div className="w-full flex flex-col gap-8 lg:px-12 lg:pt-8">
                                <Container className="flex flex-col justify-center items-start gap-4">
                                    ...
                                    >
                                        ...
                                        a Aplicação Internacional
                                    </h2>
                                    <p className="section-subtitle indent-6 lg:text-base">
                                        Esse o ponto de partida
                                        perfeito para quem deseja
                                        iniciar sua jornada de
                                        candidatura ao ensino superior
                                        no exterior. Cobrimos todo o
                                        conteúdo necessário para uma
                                        aplicação bem-sucedida, desde
                                        a escolha do curso e da
                                        universidade até a redação de
                                        uma carta de motivação
                                        convincente. Não se preocupe
                                        se você não tem experiência
                                        prévia na área, o curso é
                                        projetado para alunos de todos
                                        os níveis de conhecimento.
                                        Prepare-se para dar os
                                        primeiros passos em direção ao
